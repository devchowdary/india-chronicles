...
const MartialArts = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Martial Arts in India </title>
        <meta
          name="description"
          content="Discover the diverse and historic martial arts of India, including Kalaripayattu, Silambam, Thang-Ta, and more. Explore their origins, techniques, and cultural significance."
        />
      </Helmet>
