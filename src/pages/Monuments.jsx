...
const Monuments = () => {
  ...
  return (
    <>
      {/* Helmet to manage page metadata */}
      <Helmet>
        <title>Monuments of India</title>
        <meta name="description" content="Explore the iconic monuments of India, including historical sites, architectural marvels, and cultural landmarks." />
        <meta name="keywords" content="India monuments, historical sites, cultural landmarks, Indian architecture, famous monuments in India" />
          ...
          <Grid container spacing={4} marginLeft="-10px">
            {topMonumentsInIndia.map((monument, index) => (
              <Grid item xs={12} sm={6} md={4} key={index}>
                <Card
                  sx={{ maxWidth: '350px', height: '500px', margin: 'auto', boxShadow: 3 }}
                >
                  <CardMedia
                    component="img"
                    height="330"
