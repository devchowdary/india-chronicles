...
const images = [
  ...
  { src: lakshanadevi, alt: ' goddess lakshana devi', title: 'lakshana devi ', location: 'bharmour', description: 'Lakshmi Devi is the Hindu goddess  prosperity, often depicted on a lotus. She is the consort of Lord Vishnu and is worshipped for blessings of abundance, especially during festivals like Diwali.' },
  ...
  { src: taradevi, alt: 'goddess tara', title: 'goddess tara devi', location: 'shimla', description: 'In Rameshwaram, Lord Shiva is worshipped as Ramanathaswamy, one of the twelve Jyotirlingas.  significant for its sacred rituals, is believed to have been built by Lord Rama to atone for his sins.' },
